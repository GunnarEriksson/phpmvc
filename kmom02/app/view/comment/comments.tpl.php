...
<div class='admin-field'>
    <span class='admin'><a href='<?=$this->url->create('comment/view-edit/' . $pageKey . '/' . $id)?>'>Redigera</a></span>
    <span class='admin'><a href='<?=$this->url->create('comment/view-delete/' . $pageKey . '/' . $id)?>'>Radera</a></span>
</div>
</div>
</div>
<?php endforeach; ?>
