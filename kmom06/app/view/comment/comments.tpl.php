...
<div class='admin-field'>
    <span class='delete-comment'><a href='<?=$this->url->create('comment/view-delete/' . $pageKey . '/' . $comment->id)?>'><i class="fa fa-trash-o" style="color:red" aria-hidden="true"></i></a></span>
    <span class='edit-comment'><a href='<?=$this->url->create('comment/view-edit/' . $pageKey . '/' . $comment->id)?>'><i class="fa fa-pencil-square-o" style="color:green" aria-hidden="true"></i></a></span>
</div>
</div>
</div>
<?php endforeach; ?>
